# 📊 DeFi Protocol Revenue & User Attribution Pipeline (PoC)
...
![Revenue & Protocol Performance](docs/revenue_protocol_performance.png)

### Business Health & Cohort Retention
![Business Health & Cohort Retention](docs/business_health_cohort_retention.png)

### BADE Sybil, Smart Money Prob, Cross-Chain Nomad
![BADE Sybil, Smart Money Prob, Cross-Chain Nomad](docs/bade_sybil_smart_money.png)
...
│                         EXTRACT (Python)                           │
│  ┌─────────────┐  ┌──────────────┐  ┌────────────┐  ┌──────────┐   │
│  │  Etherscan  │  │  DeFiLlama   │  │    Dune    │  │CoinGecko │   │
...
┌─────────────────────────────────────────────────────────────────────┐
│                        TRANSFORM (dbt)                              │
│  Staging → stg_etherscan, stg_defillama, stg_dune, stg_coingecko    │
│  Marts   → fct_cohort_retention, fct_daily_revenue_attribution      │
└────────────────────────────────┬────────────────────────────────────┘
                                 ▼
┌─────────────────────────────────────────────────────────────────────┐
│                      ORCHESTRATE + VISUALIZE                        │
│                Evidence.dev Dashboard (Docs-as-code)                │
└─────────────────────────────────────────────────────────────────────┘
```
